...
public class Deleteme {
    ...
    private Logger log = Logger.getLogger(Deleteme.class.getName());
     ...
     */
    public Deleteme(String endpointURL) throws MalformedURLException {
    ...
    public static void main(String[] args) {
        String endpointURL = "http://remanplanet.com/drupal/api/1.0"; //Set your own http://[drupal host]/[endpoint] URL
        String adminName = "admin"; //Set your own admin user name
        String adminPass = "admin"; //Set your own admin user password
        ...
        try {
            Deleteme service = new Deleteme(endpointURL);
